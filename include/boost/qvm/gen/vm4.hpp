...
boost
    ...
    qvm
        ...
        operator*( A const & a, B const & b )
            ...
            R r;
            v_traits<R>::template w<0>(r)=a00*b0+a01*b1+a02*b2+a03*b3;
            v_traits<R>::template w<1>(r)=a10*b0+a11*b1+a12*b2+a13*b3;
            v_traits<R>::template w<2>(r)=a20*b0+a21*b1+a22*b2+a23*b3;
            v_traits<R>::template w<3>(r)=a30*b0+a31*b1+a32*b2+a33*b3;
            return r;
            }
        ...
        BOOST_QVM_INLINE_OPERATIONS
        typename lazy_enable_if_c<
            m_traits<B>::rows==4 && m_traits<B>::cols==4 &&
            v_traits<A>::dim==4,
            deduce_v2<A,B,4> >::type
        operator*( A const & a, B const & b )
            {
            ...
            BOOST_QVM_STATIC_ASSERT(v_traits<R>::dim==4);
            R r;
            v_traits<R>::template w<0>(r)=a0*b00+a1*b10+a2*b20+a3*b30;
            v_traits<R>::template w<1>(r)=a0*b01+a1*b11+a2*b21+a3*b31;
            v_traits<R>::template w<2>(r)=a0*b02+a1*b12+a2*b22+a3*b32;
            v_traits<R>::template w<3>(r)=a0*b03+a1*b13+a2*b23+a3*b33;
            return r;
            }
