...
boost
	...
	qvm
		...
		template <class T,int Dim>
		struct
		m_traits< qvm_detail::identity_mat_<T,Dim> >
			{
		...
		typename enable_if_c<
			...
			A &>::type
		operator/=( A & a, typename m_traits<A>::scalar_type b )
			{
		...
		typename lazy_enable_if_c<
			...
			deduce_m<A> >::type
		operator/( A const & a, typename m_traits<A>::scalar_type b )
			{
		...
		typename lazy_enable_if_c<
			...
			deduce_m<A> >::type
		inverse( A const & a, typename m_traits<A>::scalar_type det )
			{
		...
		template <class T,int Rows,int Cols>
		struct
		m_traits< qvm_detail::zero_mat_<T,Rows,Cols> >
			{
		...
		struct
		deduce_m<qvm_detail::zero_mat_<T,Rows,Cols>,R,C>
			{
		...
		qvm_detail
			...
			rot_mat_
				...
				BOOST_QVM_INLINE
				rot_mat_( V const & axis, typename v_traits<V>::scalar_type angle )
					{
			...
			template <> struct rot_mat_get<0,0> { template <class T> static BOOST_QVM_INLINE_CRITICAL T get( T const (&a)[3][3] ) { return a[0][0]; }; };
			template <> struct rot_mat_get<0,1> { template <class T> static BOOST_QVM_INLINE_CRITICAL T get( T const (&a)[3][3] ) { return a[0][1]; }; };
			template <> struct rot_mat_get<0,2> { template <class T> static BOOST_QVM_INLINE_CRITICAL T get( T const (&a)[3][3] ) { return a[0][2]; }; };
			template <> struct rot_mat_get<1,0> { template <class T> static BOOST_QVM_INLINE_CRITICAL T get( T const (&a)[3][3] ) { return a[1][0]; }; };
			template <> struct rot_mat_get<1,1> { template <class T> static BOOST_QVM_INLINE_CRITICAL T get( T const (&a)[3][3] ) { return a[1][1]; }; };
			template <> struct rot_mat_get<1,2> { template <class T> static BOOST_QVM_INLINE_CRITICAL T get( T const (&a)[3][3] ) { return a[1][2]; }; };
			template <> struct rot_mat_get<2,0> { template <class T> static BOOST_QVM_INLINE_CRITICAL T get( T const (&a)[3][3] ) { return a[2][0]; }; };
			template <> struct rot_mat_get<2,1> { template <class T> static BOOST_QVM_INLINE_CRITICAL T get( T const (&a)[3][3] ) { return a[2][1]; }; };
			template <> struct rot_mat_get<2,2> { template <class T> static BOOST_QVM_INLINE_CRITICAL T get( T const (&a)[3][3] ) { return a[2][2]; }; };
			}
		...
		template <int D,class V>
		struct
		m_traits< qvm_detail::rot_mat_<D,V> >
			{
			...
			r( this_matrix const & x )
				...
				return qvm_detail::rot_mat_get<Row,Col>::get(x.a);
				}
		...
		rot_mat( A const & axis, typename v_traits<A>::scalar_type angle )
			{
		...
		set_rot( A & a, B const & axis, typename v_traits<B>::scalar_type angle )
			{
			assign(a,rot_mat<m_traits<A>::rows>(axis,angle));
			}
		...
		rotate( A & a, B const & axis, typename v_traits<B>::scalar_type angle )
			{
			a *= rot_mat<m_traits<A>::rows>(axis,angle);
			}
		...
		template <int Dim,class Angle>
		struct
		m_traits< qvm_detail::rotx_mat_<Dim,Angle> >
			{
			...
			r( this_matrix const & x )
				...
				BOOST_QVM_STATIC_ASSERT(Row<Dim);
				BOOST_QVM_STATIC_ASSERT(Col<Dim);
				return qvm_detail::rotx_mat_get<Row,Col>::get(reinterpret_cast<Angle const &>(x));
				}
		...
		template <int Dim,class Angle>
		struct
		deduce_m<qvm_detail::rotx_mat_<Dim,Angle>,Dim,Dim>
			{
		...
		template <int Dim,class Angle>
		struct
		deduce_m2<qvm_detail::rotx_mat_<Dim,Angle>,qvm_detail::rotx_mat_<Dim,Angle>,Dim,Dim>
			{
			typedef mat<Angle,Dim,Dim> type;
			};
		...
		typename enable_if_c<
			...
			m_traits<A>::rows==m_traits<A>::cols,
			void>::type
		set_rotx( A & a, typename m_traits<A>::scalar_type angle )
			{
			assign(a,rotx_mat<m_traits<A>::rows>(angle));
			}
		...
		typename enable_if_c<
			...
			m_traits<A>::rows==m_traits<A>::cols,
			void>::type
		rotate_x( A & a, typename m_traits<A>::scalar_type angle )
			{
			a *= rotx_mat<m_traits<A>::rows>(angle);
			}
		...
		template <int Dim,class Angle>
		struct
		m_traits< qvm_detail::roty_mat_<Dim,Angle> >
			{
			...
			r( this_matrix const & x )
				...
				BOOST_QVM_STATIC_ASSERT(Row<Dim);
				BOOST_QVM_STATIC_ASSERT(Col<Dim);
				return qvm_detail::roty_mat_get<Row,Col>::get(reinterpret_cast<Angle const &>(x));
				}
		...
		template <int Dim,class Angle>
		struct
		deduce_m<qvm_detail::roty_mat_<Dim,Angle>,Dim,Dim>
			{
			typedef mat<Angle,Dim,Dim> type;
			};
		...
		template <int Dim,class Angle>
		struct
		deduce_m2<qvm_detail::roty_mat_<Dim,Angle>,qvm_detail::roty_mat_<Dim,Angle>,Dim,Dim>
			{
			typedef mat<Angle,Dim,Dim> type;
			};
		...
		typename enable_if_c<
			...
			m_traits<A>::rows==m_traits<A>::cols,
			void>::type
		set_roty( A & a, typename m_traits<A>::scalar_type angle )
			{
			assign(a,roty_mat<m_traits<A>::rows>(angle));
			}
		...
		typename enable_if_c<
			...
			m_traits<A>::rows==m_traits<A>::cols,
			void>::type
		rotate_y( A & a, typename m_traits<A>::scalar_type angle )
			{
			a *= roty_mat<m_traits<A>::rows>(angle);
			}
		...
		template <int Dim,class Angle>
		struct
		m_traits< qvm_detail::rotz_mat_<Dim,Angle> >
			{
			...
			r( this_matrix const & x )
				...
				BOOST_QVM_STATIC_ASSERT(Row<Dim);
				BOOST_QVM_STATIC_ASSERT(Col<Dim);
				return qvm_detail::rotz_mat_get<Row,Col>::get(reinterpret_cast<Angle const &>(x));
				}
		...
		template <int Dim,class Angle>
		struct
		deduce_m<qvm_detail::rotz_mat_<Dim,Angle>,Dim,Dim>
			{
			typedef mat<Angle,Dim,Dim> type;
			};
		...
		struct
		deduce_m2<qvm_detail::rotz_mat_<Dim,Angle>,qvm_detail::rotz_mat_<Dim,Angle>,R,C>
			{
		...
		typename enable_if_c<
			...
			m_traits<A>::rows==m_traits<A>::cols,
			void>::type
		set_rotz( A & a, typename m_traits<A>::scalar_type angle )
			{
			assign(a,rotz_mat<m_traits<A>::rows>(angle));
			}
		...
		typename enable_if_c<
			...
			m_traits<A>::rows==m_traits<A>::cols,
			void>::type
		rotate_z( A & a, typename m_traits<A>::scalar_type angle )
			{
			a *= rotz_mat<m_traits<A>::rows>(angle);
			}
