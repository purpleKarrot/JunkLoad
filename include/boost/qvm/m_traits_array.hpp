...
boost
    ...
    qvm
        ...
        template <class T,int Rows,int Cols,int R,int C>
        struct
        deduce_m<T const[Rows][Cols],R,C>
            {
            typedef mat<T,R,C> type;
            };
        ...
        struct
        deduce_m2<T1[Rows][Cols],T2[Rows][Cols],R,C>
            {
            typedef mat<typename deduce_s<T1,T2>::type,R,C> type;
            };
        }
    }
