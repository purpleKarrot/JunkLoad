...
boost
    ...
    qvm
        ...
        template <class T>
        struct
        q_traits< qvm_detail::identity_q_<T> >
            {
        ...
        qvm_detail
            ...
            rot_q_
                ...
                BOOST_QVM_INLINE
                rot_q_( V const & axis, typename v_traits<V>::scalar_type angle )
                    {
        ...
        rot_q( A const & axis, typename v_traits<A>::scalar_type angle )
            {
        ...
        struct
        q_traits< qvm_detail::rotx_q_<Angle> >
            {
        ...
        template <class Angle>
        struct
        deduce_q< qvm_detail::rotx_q_<Angle> >
            {
        ...
        template <class Angle>
        struct
        deduce_q2< qvm_detail::rotx_q_<Angle>, qvm_detail::rotx_q_<Angle> >
            {
            typedef quat<Angle> type;
            };
        ...
        template <class Angle>
        struct
        q_traits< qvm_detail::roty_q_<Angle> >
            {
        ...
        template <class Angle>
        struct
        deduce_q< qvm_detail::roty_q_<Angle> >
            {
            typedef quat<Angle> type;
            };
        ...
        template <class Angle>
        struct
        deduce_q2< qvm_detail::roty_q_<Angle>, qvm_detail::roty_q_<Angle> >
            {
            typedef quat<Angle> type;
            };
        ...
        template <class Angle>
        struct
        q_traits< qvm_detail::rotz_q_<Angle> >
            {
        ...
        template <class Angle>
        struct
        deduce_q< qvm_detail::rotz_q_<Angle> >
            {
            typedef quat<Angle> type;
            };
        ...
        template <class Angle>
        struct
        deduce_q2< qvm_detail::rotz_q_<Angle>, qvm_detail::rotz_q_<Angle> >
            {
            typedef quat<Angle> type;
            };
