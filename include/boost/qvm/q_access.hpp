    ...
    qvm
        ...
        v_traits< qvm_detail::quat_v_<Q> >
            ...
            r( qvm_detail::quat_v_<Q> const & q )
                ...
                return q_traits<Q>::template r<I+1>( reinterpret_cast<Q const &>(q) );
                }
            ...
            w( qvm_detail::quat_v_<Q> & q )
                ...
                BOOST_QVM_STATIC_ASSERT(I>=0);
                BOOST_QVM_STATIC_ASSERT(I<dim);
                return q_traits<Q>::template w<I+1>( reinterpret_cast<Q &>(q) );
                }
            };
        ...
        operator%( Q const & a, vector_access_tag<I> (*)() )
            ...
            return q_traits<Q>::template r<I+1>(a);
            }
        ...
        operator%( Q & a, vector_access_tag<I> (*)() )
            ...
            BOOST_QVM_STATIC_ASSERT(I>=0);
            BOOST_QVM_STATIC_ASSERT(I<3);
            return q_traits<Q>::template w<I+1>(a);
            }
