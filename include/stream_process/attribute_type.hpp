...
template<>
inline bool
attribute_type< vec2f >::operator()( const attribute& attribute_ )
{
...
template<>
inline bool
attribute_type< vec3f >::operator()( const attribute& attribute_ )
{
    if ( attribute_.get_data_type_id() != SP_FLOAT_32 )
        return false;
...
template<>
inline bool
attribute_type< vec3ui >::operator()( const attribute& attribute_ )
{
...
template<>
inline bool
attribute_type< vec4f >::operator()( const attribute& attribute_ )
{
    if ( attribute_.get_data_type_id() != SP_FLOAT_32 )
        return false;
...
template<>
inline bool
attribute_type< vec2d >::operator()( const attribute& attribute_ )
{
...
template<>
inline bool
attribute_type< vec3d >::operator()( const attribute& attribute_ )
{
    if ( attribute_.get_data_type_id() != SP_FLOAT_64 )
        return false;
    if ( attribute_.get_number_of_elements() != 3 )
...
template<>
inline bool
attribute_type< vec4d >::operator()( const attribute& attribute_ )
{
    if ( attribute_.get_data_type_id() != SP_FLOAT_64 )
        return false;
    if ( attribute_.get_number_of_elements() != 4 )
...
template<>
inline bool
attribute_type< vec4ub >::operator()( const attribute& attribute_ )
{
...
template<>
inline bool
attribute_type< mat3f >::operator()( const attribute& attribute_ )
{
    if ( attribute_.get_data_type_id() != SP_FLOAT_32 )
        return false;
...
template<>
inline bool
attribute_type< mat4f >::operator()( const attribute& attribute_ )
{
    if ( attribute_.get_data_type_id() != SP_FLOAT_32 )
        return false;
...
template<>
inline bool
attribute_type< mat3d >::operator()( const attribute& attribute_ )
{
    if ( attribute_.get_data_type_id() != SP_FLOAT_64 )
        return false;
    if ( attribute_.get_number_of_elements() != 9 )
...
template<>
inline bool
attribute_type< mat4d >::operator()( const attribute& attribute_ )
{
    if ( attribute_.get_data_type_id() != SP_FLOAT_64 )
        return false;
    if ( attribute_.get_number_of_elements() != 16 )
