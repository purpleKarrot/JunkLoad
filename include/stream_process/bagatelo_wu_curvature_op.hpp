#ifndef __STREAM_PROCESS__BAGATELO_WU_CURVATURE_OP__HPP__
#define __STREAM_PROCESS__BAGATELO_WU_CURVATURE_OP__HPP__
...
class bagatelo_wu_curvature_op : public operator_base_t
{
public:
    ...
    virtual operator_base_t* clone() { return new bagatelo_wu_curvature_op( *this ); }
...
}; // class bagatelo_wu_curvature_op


#define SP_CLASS_NAME      bagatelo_wu_curvature_op< operator_base_t >
