...
inline void
data_element::set_size( size_t size_ )
{
    _size = size_;
    update();
}
...
inline void
data_element::set_offset( size_t offset_ )
{
    _offset = offset_;
}
...
inline size_t
data_element::get_size_in_bytes() const
{
...
inline size_t
data_element::get_data_size_in_bytes() const
{
...
inline size_t
data_element::get_file_size_in_bytes() const
{
...
template< typename container_t >
bool
data_element::set_from_strings( const container_t& tokens )
{
    if ( tokens.size() < 2 ) 
        return false;
