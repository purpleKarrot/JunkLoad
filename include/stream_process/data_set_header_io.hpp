...
{
public:
    void read_from_file( const std::string& filename_base, data_set_header& hdr_ );
    void write_to_file( const std::string& filename_base, const data_set_header& hdr_ );
...
protected:
    ...
    data_set_header     _working_copy; // FIXME remove
