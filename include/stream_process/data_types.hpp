...
{
    data_type_id operator()(){ return SP_UNKNOWN_DATA_TYPE; }
    static std::string get_name_string() { return "unimplemented type."; }
...
{
    data_type_id operator()(){ return SP_FLOAT_32; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_FLOAT_64; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_INT_8; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_UINT_8; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_INT_16; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_UINT_16; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_INT_32; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_UINT_32; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_INT_64; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_UINT_64; }
}; // strcut get_data_type_id_from_type
...
{
    data_type_id operator()(){ return SP_STRING; }
}; // strcut get_data_type_id_from_type
