...
private:
  ...
  inline const value_t& median(
    const value_t& _begin, const value_t& _middle, const value_t& _end ) const;
...
intro_sort< value_t, iterator_t, compare_t >::
median( const value_t& begin_, const value_t& middle_, const value_t& end_ ) const
{
...
inline void
intro_sort< value_t, iterator_t, compare_t >::
insertion_sort( iterator_t begin_, iterator_t end_ ) const
{
...
inline void
intro_sort< value_t, iterator_t, compare_t >::
operator()( iterator_t begin_, iterator_t end_ ) const
{
    if ( end_ - begin_ > 1 )
    {
...
void
intro_sort< value_t, iterator_t, compare_t >::
sort( iterator_t begin_, iterator_t end_, size_t depth_ ) const
{
    while ( end_ - begin_ > 1 )
    {
        ...
        if ( r > 1 )
        {
            if ( r < THREAD_THRESHOLD )
                ...
                _threadpool.schedule(
                    boost::bind( &intro_sort::sort, this, i, end_, depth_ )
                    );
        }
