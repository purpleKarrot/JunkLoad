...
public:
	...
	const data_set_header& get_header() const;
...
template<typename T>
attribute_accessor<T> point_set::get_accessor(const std::string& attr_name) const
{
...
inline bool point_set::has_attribute(const std::string& name)
{
