#ifndef __STREAM_PROCESS__ZERO_VERTEX_NORMAL_OP__HPP__
#define __STREAM_PROCESS__ZERO_VERTEX_NORMAL_OP__HPP__
...
class zero_vertex_normal_op : public operator_base_t
{
public:
    ...
    virtual operator_base_t* clone() { return new zero_vertex_normal_op( *this ); }
...
#define SP_CLASS_NAME      zero_vertex_normal_op< operator_base_t >
