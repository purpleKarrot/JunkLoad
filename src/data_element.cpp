...
std::string
data_element::to_header_string() const
{
    std::string result = "element ";
    result += _name;
    result += "\n";
...
std::string
data_element::get_filename( const std::string& base_filename ) const
{
...
void
data_element::merge_input( const data_element& input_element_ )
{
