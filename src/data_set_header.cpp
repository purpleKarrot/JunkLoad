...
bool
data_set_header::has_faces() const
{
    return ! _faces.empty();
}
...
size_t
data_set_header::get_number_of_vertices() const
{
...
void
data_set_header::set_number_of_vertices( size_t num )
{
...
size_t
data_set_header::get_number_of_faces() const
{
    return _faces.size();
}
...
void
data_set_header::set_number_of_faces( size_t num )
{
    _faces.set_size( num );
}
...
size_t
data_set_header::get_vertex_offset() const
{
...
void
data_set_header::set_vertex_offset( size_t offset )
{
    _vertices.set_offset( offset );
}

size_t
data_set_header::get_face_offset() const
{
...
void
data_set_header::set_face_offset( size_t offset )
{
...
void
data_set_header::set_data_is_big_endian( bool is_big_endian )
{
...
bool
data_set_header::get_data_is_big_endian() const
{
...
void
data_set_header::read_from_file( const std::string& filename_base )
{
...
void
data_set_header::write_to_file( const std::string& filename_base ) const
{
    data_set_header_io io;
...
void
data_set_header::merge_input( const data_set_header& input_header_ )
{
    ...
    data_set_header::const_iterator
        in_it = input_header_.begin(), in_it_end = input_header_.end();
    data_set_header::iterator
        it = begin(), it_end = end();
...
void
data_set_header::update_float_precision( data_type_id sp, data_type_id hp )
{
    data_set_header::iterator
        eit = begin(), eit_end = end();
    for( ; eit != eit_end; ++eit )
    {
...
void
data_set_header::finalize_structures()
{
    data_set_header::iterator
        eit = begin(), eit_end = end();
    for( ; eit != eit_end; ++eit )
