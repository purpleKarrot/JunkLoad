...
data_type_id
data_type_helper::get_data_type_id( const std::string& name ) const
{
    std::map< std::string, data_type_id >::const_iterator it 
        = _type_names.find( name );
...
size_t
data_type_helper::get_size_in_bytes( data_type_id type ) const
{
